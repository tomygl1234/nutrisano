function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResoponsive)}function navegacionResoponsive(){document.querySelector(".navegacion-principal").classList.toggle("mostrar")}
